...
data = pd.read_excel("Energy Indicators.xls", sheet_name=0, skiprows=16, skipfooter=38).iloc[:,2:6]
print(data.columns)
#drop(["Unnamed: 0", "Unnamed: 1"], axis=1).rename(columns ={"Unnamed: 2":"Country",
